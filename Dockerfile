...
RUN apk add --no-cache build-base bash curl nodejs postgresql-client tzdata postgresql-dev
...
RUN apk add --no-cache build-base git postgresql-dev nodejs npm python3 py3-pip
